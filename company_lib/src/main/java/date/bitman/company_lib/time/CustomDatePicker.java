package date.bitman.company_lib.time;
...
public class CustomDatePicker {
    ...
    public static final int Y_M = 0x0002;
    public static final int M_D = 0x0003;
    public static final int Y_M_D = 0x0004;
    public int type;
    ...
    private RobotTimePicker year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private TextView tv_cancle, tv_select, hour_text, minute_text, day_text, year_text;
    ...
    private void initView() {
        year_pv = (RobotTimePicker) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (RobotTimePicker) datePickerDialog.findViewById(R.id.month_pv);
        day_pv = (RobotTimePicker) datePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (RobotTimePicker) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (RobotTimePicker) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void initTimer() {
        ...
        if (spanYear) {
            ...
            if ((scrollUnits & SCROLL_TYPE.HOUR.value) != SCROLL_TYPE.HOUR.value) {
                hour.add(formatTimeUnit(startHour)+"时");
            } else {
            ...
            if ((scrollUnits & SCROLL_TYPE.MINUTE.value) != SCROLL_TYPE.MINUTE.value) {
                minute.add(formatTimeUnit(startMinute)+"分");
            } else {
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new RobotTimePicker.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new RobotTimePicker.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new RobotTimePicker.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new RobotTimePicker.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new RobotTimePicker.onSelectListener() {
            @Override
            public void onSelect(String text) {
    ...
    private void hourChange() {
        if ((scrollUnits & SCROLL_TYPE.HOUR.value) == SCROLL_TYPE.HOUR.value) {
            ...
            selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(hour.get(0).replace("时","")));
            hour_pv.setData(hour);
            hour_pv.setSelected(0);
    ...
    private void minuteChange() {
        if ((scrollUnits & SCROLL_TYPE.MINUTE.value) == SCROLL_TYPE.MINUTE.value) {
            ...
            selectedCalender.set(Calendar.MINUTE, Integer.parseInt(minute.get(0).replace("分","")));
            minute_pv.setData(minute);
            minute_pv.setSelected(0);
